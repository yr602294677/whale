package com.yangrui.whale.generate.utils;
...
public class GenUtil {
     ...
     */
    public static void generator(List<ColumnInfo> columnInfos, GenConfig genConfig, String tableName) throws IOException {
        ...
        for (String templateName : templates) {
            Template template = engine.getTemplate("ftl/admin/"+templateName+".ftl");
